...
to go
  ...
  ask turtles with [ wealth > -20 ] [ transact ]
...
to transact
  ;; spend 0.5% of wealth to another turtle
  let spend 0.005 * wealth
  set spend max list 1 spend
  set wealth wealth - spend
  ask one-of other turtles [ set wealth wealth + spend ]
end
